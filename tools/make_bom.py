...
def main(name="bass viol+cello", out="BOM.md"):
    ...
    A("")
    A("## Two things this list assumes")
    A("")
    ...
    A("")
    A("**No grub screws.** The original clamps the microphone arm with two")
    A("tapered grub screws. Here the arm is gripped by the fins on the holder")
    A("and slides in that slot to set the microphone position, so those two")
    A("screws are not needed. If your printer runs loose and the arm slides too")
    A("freely, adjust `fits.arm_slot` and reprint the holder rather than adding")
    A("a screw.")
    A("")
